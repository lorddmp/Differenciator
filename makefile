a: main.cpp print_tree.cpp tech_func.cpp Calculator/count_calculator.cpp Calculator/count_calc_funcs.cpp Calculator/calculator.cpp Calculator/calc_func.cpp differenciator.cpp reading_tree.cpp;
	g++ -ICalculator -I. -D _DEBUG -ggdb3 -std=c++17 -O0 -Wall -Wextra -Weffc++ \
...
-Wstack-usage=8192 -pie -fPIE -Werror=vla  main.cpp print_tree.cpp tech_func.cpp Calculator/count_calculator.cpp Calculator/count_calc_funcs.cpp Calculator/calculator.cpp Calculator/calc_func.cpp differenciator.cpp reading_tree.cpp -o diff.out