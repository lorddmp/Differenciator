a: main.cpp read_tree.cpp print_tree.cpp tech_func.cpp tree_calculator.cpp;
...
-Wstack-usage=8192 -pie -fPIE -Werror=vla  main.cpp read_tree.cpp print_tree.cpp tech_func.cpp tree_calculator.cpp -o diff.out