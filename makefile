a: main.cpp read_tree.cpp print_tree.cpp tech_func.cpp Calculator/count_calculator.cpp Calculator/count_calc_funcs.cpp Calculator/calculator.cpp Calculator/calc_func.cpp differenciator.cpp;
...
-Wstack-usage=8192 -pie -fPIE -Werror=vla  main.cpp read_tree.cpp print_tree.cpp tech_func.cpp Calculator/count_calculator.cpp Calculator/count_calc_funcs.cpp Calculator/calculator.cpp Calculator/calc_func.cpp differenciator.cpp -o diff.out