a: main.cpp read_tree.cpp print_tree.cpp tech_func.cpp tree_calculator_get_vars.cpp calc_funcs.cpp;
	g++ -Istack -D _DEBUG -ggdb3 -std=c++17 -O0 -Wall -Wextra -Weffc++ \
...
-Wstack-usage=8192 -pie -fPIE -Werror=vla  main.cpp read_tree.cpp print_tree.cpp tech_func.cpp tree_calculator_get_vars.cpp calc_funcs.cpp -o diff.out